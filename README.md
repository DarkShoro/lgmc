...
[![Version](https://img.shields.io/badge/version-2.8.7--SNAPSHOT-blue.svg)](https://github.com/DarkShoro/lgmc/releases)
...
2. Place the `lgmc-2.8.7-SNAPSHOT.jar` file in your server's `plugins/` folder
...
# build/libs/lgmc-2.8.7-SNAPSHOT.jar
```
