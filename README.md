...
[![Version](https://img.shields.io/badge/version-6.0.0-blue.svg)](https://github.com/DarkShoro/lgmc/releases)
...
1. Download `lgmc-6.0.0.jar` from [releases](https://github.com/DarkShoro/lgmc/releases)
...
# Output: build/libs/lgmc-6.0.0.jar
```
