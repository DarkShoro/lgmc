...
[![Version](https://img.shields.io/badge/version-5.1.4-blue.svg)](https://github.com/DarkShoro/lgmc/releases)
...
1. Download `lgmc-5.1.4.jar` from [releases](https://github.com/DarkShoro/lgmc/releases)
...
# Output: build/libs/lgmc-5.1.4.jar
```
