...
[![Version](https://img.shields.io/badge/version-5.0.0-blue.svg)](https://github.com/DarkShoro/lgmc/releases)
...
1. Download `lgmc-5.0.0.jar` from [releases](https://github.com/DarkShoro/lgmc/releases)
...
# Output: build/libs/lgmc-5.0.0.jar
```
